About mcerp-feedstock
=====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mcerp-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/tisimst/mcerp

Documentation: https://github.com/tisimst/mcerp/tree/master/doc
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6307&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mcerp-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mcerp` can be installed with `conda`:
...
It is possible to list all of the versions of `mcerp` available on your platform with `conda`:
...
```
mamba search mcerp --channel conda-forge
```
...
mamba repoquery search mcerp --channel conda-forge

# List packages depending on `mcerp`:
mamba repoquery whoneeds mcerp --channel conda-forge

# List dependencies of `mcerp`:
mamba repoquery depends mcerp --channel conda-forge
```
